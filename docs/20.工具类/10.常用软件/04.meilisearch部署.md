...
docker run -itd --name meilisearch -p 7700:7700 \
  ...
  -e MEILI_HTTP_SSL_ADDR=0.0.0.0:7700 \
  -e MEILI_HTTP_SSL_KEY=/etc/ssl/certs/xiaoying.org.cn.key \
  -e MEILI_HTTP_SSL_CERTIFICATE=/etc/ssl/certs/xiaoying.org.cn_bundle.crt \
...
// 全文搜索插件 meilisearch
  [
    'vuepress-plugin-meilisearch',
      {
          hostUrl: 'http://服务器ip:7700',  // 服务器防火墙开7700端口
